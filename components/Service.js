          ...
          <div className="flex gap-5 ">
            <div className="flex flex-col gap-5 items-start bg-[#81818B]/10 px-6 rounded-xl py-4 mt-5">
              ...
              <p className="text-base text-black ">
                ...
                <br /> lobortis arcu enim urna <br /> adipiscing praesent velit.
              </p>
              <p className="btn btn-primary bg-[#09A79D] border-color-[#09A79D] rounded-full w-44 capitalize text-white hover:bg-transparent">
                Consulter
              </p>
            </div>
            <div className="flex flex-col gap-5 items-start bg-[#81818B]/10 px-6 rounded-xl py-4 -mt-10">
              ...
              <p className="text-xl font-semibold text-black text-black">
                Ingénierie{" "}
              </p>
              <p className="text-base text-black ">
                Lorem ipsum dolor sit amet, <br /> consectetur adipiscing elit{" "}
