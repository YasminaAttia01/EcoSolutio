...
const Blog = () => {
  const testimonials = [
    ...
    },
    {
      ...
      date: "21 Aug 2022",
      title:
        "Plannification du projet de couverture du désert par les panneaux solaires",
      sub: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero.",
    },
    {
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex ">
        <button className="btn btn-primary bg-[#09A79D] border-color-[#09A79D] rounded-full w-44 capitalize text-white ">
          Tous les articles
        </button>
      </div>
      <br></br> <br></br> <br></br>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-10">
        {testimonials.map((tes, i) => {
          return (
            <div
              key={i}
              className="bg-[#9C9C9C]/10 rounded-xl overflow-hidden pb-10 "
            >
              <div className="relative">
                <img className="w-full" src={tes.img} alt="person" />
              </div>

              <div className="flex flex-col gap-6 px-6 py-6 items-start">
